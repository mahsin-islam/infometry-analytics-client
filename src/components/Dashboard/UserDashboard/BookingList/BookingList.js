...
const BookingList = () => {
    ...
    useEffect(() => {
        axios.get(`https://whispering-fortress-28180.herokuapp.com/bookingList?email=${user.email}`)
        ...
        swal({
          ...
          .then( wantDelete => {
            if (wantDelete) {
                ...
                axios.delete(`https://whispering-fortress-28180.herokuapp.com/deleteOrder/${id}`)
                .then(res => {
