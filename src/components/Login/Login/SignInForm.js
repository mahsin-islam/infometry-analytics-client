...
import ifoIcon from '../../../images/info.svg'
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} class="sign-in-form">
            ...
            <div class="input-field">
                ...
                <input defaultValue='programminghero001@gmail.com' placeholder="Email" {...register("email", { required: true })} />
            </div>
            {errors.email && <span className="text-warning">This field is required</span>}
            <div class="input-field">
                <span className="fIcon"><FontAwesomeIcon icon={faLock}/></span>
                <input defaultValue="Test12345" type="password" placeholder="Password" {...register("password", { required: true })} />
            </div>
